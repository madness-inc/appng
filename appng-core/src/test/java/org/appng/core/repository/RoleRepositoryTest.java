...
public class RoleRepositoryTest extends AbstractRepositoryTest {
	...
	public void test() {
		...
		Assert.assertEquals(applicationRole, applicationRoleRepository.findById(applicationRole.getId()).orElse(null));
		...
		Assert.assertNull(applicationRoleRepository.findById(applicationRole.getId()).orElse(null));
	}
}
