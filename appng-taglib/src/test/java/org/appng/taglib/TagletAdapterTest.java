...
public class TagletAdapterTest {
	...
	public void test() throws Exception {
		...
		Mockito.when(tagletProcessor.perform(Mockito.any(), Mockito.any(), Mockito.any(),
				Mockito.any(), Mockito.any(), Mockito.any(), Mockito.any(), Mockito.any())).thenAnswer(tagletProcessorAnswer);
