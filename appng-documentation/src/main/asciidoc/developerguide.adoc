...
:lucene: https://lucene.apache.org/core/9_12_3/core/index.html
:spring: https://docs.spring.io/spring-framework/docs/{spring-version}
...
:jse: https://docs.oracle.com/en/java/javase/21/docs/api
:jee: https://jakarta.ee/specifications/platform/11/apidocs
