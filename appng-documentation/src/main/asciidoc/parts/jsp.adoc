...
For further details see https://eclipse-ee4j.github.io/jakartaee-tutorial/web/jsf-custom/jsf-custom012.html[section 15.12.2^] of the https://eclipse-ee4j.github.io/jakartaee-tutorial/[The Jakarta EE Tutorial^].
====
