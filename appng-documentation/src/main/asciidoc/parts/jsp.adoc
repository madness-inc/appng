...
For further details see https://jakartaee.github.io/jakartaee-tutorial/#creating-custom-ui-components-and-other-custom-objects[the custom UI components section^] of the https://jakartaee.github.io/jakartaee-tutorial/[The Jakarta EE Tutorial^].
====
