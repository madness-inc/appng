...
You can use any {jee}/jakarta/validation/Constraint.html[Constraint^] in your application, may it be the standard constraints from the `jakarta.validation.constraints`-package, those from http://hibernate.org/validator/[Hibernate Validator^] (shipped with appNG), or any custom and/or compound constraints.
...
* {jee}/jakarta/validation/constraints/Digits.html[jakarta.validation.constraints.Digits^]
* {jee}/jakarta/validation/constraints/Future.html[jakarta.validation.constraints.Future^]
* {jee}/jakarta/validation/constraints/Max.html[jakarta.validation.constraints.Max^]
* {jee}/jakarta/validation/constraints/Min.html[jakarta.validation.constraints.Min^]
* {jee}/jakarta/validation/constraints/NotNull.html[jakarta.validation.constraints.NotNull^]
* {jee}/jakarta/validation/constraints/Past.html[jakarta.validation.constraints.Past^]
* {jee}/jakarta/validation/constraints/Pattern.html[jakarta.validation.constraints.Pattern^]
* {jee}/jakarta/validation/constraints/Size.html[jakarta.validation.constraints.Size^]
...
<meta-data bindclass="com.myapp.domain.Employee">
    <validation><!--1-->
        <group class="jakarta.validation.groups.Default" /> <!--2-->
