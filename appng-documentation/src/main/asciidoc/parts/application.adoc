...
* `request` +
A wrapper for the current {jee}/jakarta/servlet/http/HttpServletRequest.html[jakarta.servlet.http.HttpServletRequest^], offering additional framework methods. +
...
*Type:* {jse}/java.sql/javax/sql/DataSource.html[javax.sql.DataSource^] +
*Scope:* singleton
