...
AppNG uses the https://jakartaee.github.io/jakartaee-tutorial/#expression-language[Jakarta Expression Language^] syntax to provide support for dynamic expressions. See https://jakartaee.github.io/jakartaee-tutorial/#expression-language[here^] for a list of operators.
